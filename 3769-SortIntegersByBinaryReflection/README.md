...
**Difficulty:** Easy  
[View on LeetCode](https://leetcode.com/problems/sort-integers-by-binary-reflection/)
...
Sorting by the reflected values gives `[8, 3, 6, 5]`. **Note that 3 and 6 have the same reflection, so we arrange them in increasing order of original value.
